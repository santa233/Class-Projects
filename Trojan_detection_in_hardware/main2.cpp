...
{
    std::string line;
    std::ifstream text1 ("simple2.txt");
    std::ifstream text2 ("ip2.txt");
	...
	if (text1.is_open())
	{
		...
		graph.print_datas();
		for(int k = 0; k< consv_size; k++)
		{
			std::list<std::string> list1 = list_live_signals_c[k];
			cout << "PATHS =>" << endl;
